package com.lbh.orders;

/**
 * Created by liubohan on 15/6/2.
 */
    ...
    class AT extends AsyncTask {
        ...
        protected void onPostExecute(Object result) {
            ...
            try {
                ...
                String name = jsonObj.getString("userId");
                String orderPrice = jsonObj.getString("totalPrice");
                String orderDestiantion = jsonObj.getString("des");
